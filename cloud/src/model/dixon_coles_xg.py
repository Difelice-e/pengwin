...
"""
# Nota: rispetto alla versione su PC e' stato tolto solo l'inserimento di
# pengwin/pylibs in sys.path — nel container pip funziona normalmente e scipy
# e' installato regolarmente. La matematica e' identica, byte per byte.
